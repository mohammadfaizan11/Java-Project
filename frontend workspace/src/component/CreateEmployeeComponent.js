        ...
        <div className="card  col-md-6 offset-3">
            ...
            <div className="card-body">
                <form>
                    ...
                    <br/>
                    <button className="btn btn-danger mt-3 ml-5" onClick={handleCancel}> cancel </button>
                    <button className="btn btn-success mt-3 ms-3 float-end" onClick={handleSubmit}> submit </button>
                </form>
            </div>
        </div>
    </div>
